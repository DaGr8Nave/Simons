...
def main():
    ...
    if LOAD_MODEL:
        load_checkpoint(torch.load("../../input/unet-cholecseg8k-center-crop/83epWeightedDiceTopo.pth.tar"), model)
        optimizer.load_state_dict(torch.load("../../input/unet-cholecseg8k-center-crop/83epWeightedDiceTopo.pth.tar")['optimizer'])
