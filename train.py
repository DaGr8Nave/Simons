...
def main():
    ...
    if LOAD_MODEL:
        load_checkpoint(torch.load("../../input/unet-cholecseg8k-center-crop/40epCenterCrop.pth.tar"), model)
        optimizer.load_state_dict(torch.load("../../input/unet-cholecseg8k-center-crop/40epCenterCrop.pth.tar")['optimizer'])
